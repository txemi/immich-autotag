...
- The area with the highest impact right now is fixing and re-enabling GitHub Actions (CI/CD). Currently, GitHub Actions are disabled due to the challenge of embedding the Immich client library in the build process. If you can help resolve this, your contribution would be especially valuable! You can join the discussion or contribute directly in [Issue #32](https://github.com/txemi/immich-autotag/issues/32).
