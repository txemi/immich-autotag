...
- The area with the highest impact right now is fixing and re-enabling GitHub Actions (CI/CD). Currently, GitHub Actions are disabled due to the challenge of embedding the Immich client library in the build process. If you can help resolve this, your contribution would be especially valuable!
