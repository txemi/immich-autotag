...
- Centralize documentation for album-related feature work (issue `0024`).
...
- `subtasks/0004-album-detection/`
	- `feature-album-detection-from-folders.md`
	- `plan_album_detection.md`

- `subtasks/0006-orphan-albums/`
	- `immich_issue_orphan_albums.md`
...
- `subtasks/0022-duplicate-name-albums/`
	- `README.md`
	- `subtasks/README.md`
	- `subtasks/003-initial-implementation/README.md`
	- `subtasks/005-duplicate-name-album-recovery/README.md`
		- `001-cleanup/README.md`
		- `002-preprocessing/README.md`
		- `003-fail-fast-processing/README.md`
