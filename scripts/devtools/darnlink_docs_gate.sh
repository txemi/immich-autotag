...
#
#     uvx --from "git+https://github.com/txemi/darnlink@v0.19.1" darnlink . --robustify --create-frontmatter --write
#
...
DARNLINK_REF="${DARNLINK_REF:-9a208781a13a530ace61c891e22e39a94a3fc742}"  # v0.19.1
