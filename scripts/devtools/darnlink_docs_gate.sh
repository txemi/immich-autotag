...
#
#     uvx --from "git+https://github.com/txemi/darnlink@v0.17.0" darnlink . --robustify --create-frontmatter --write
#
...
DARNLINK_REF="${DARNLINK_REF:-c4cd22dd721677a6699cd6881b662185bbd854b7}"  # v0.17.0
