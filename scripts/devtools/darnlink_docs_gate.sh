...
#
#     uvx --from "git+https://github.com/txemi/darnlink@v0.12.0" darnlink . --robustify --create-frontmatter --write
#
...
DARNLINK_REF="${DARNLINK_REF:-5c5fdece85fa716c1ef40d81218634584fa86b5d}"  # v0.12.0
