...
#
#     uvx --from "git+https://github.com/txemi/darnlink@v0.13.0" darnlink . --robustify --create-frontmatter --write
#
...
DARNLINK_REF="${DARNLINK_REF:-23a4bdad7c6bfd9092b9a774623dbaaff327149f}"  # v0.13.0
