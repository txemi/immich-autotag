...
#
#     uvx --from "git+https://github.com/txemi/darnlink@v0.15.0" darnlink . --robustify --create-frontmatter --write
#
...
DARNLINK_REF="${DARNLINK_REF:-35805f1ff9e7821ded81a79943fe978fee0233e5}"  # v0.15.0
