...
#
#     uvx --from "git+https://github.com/txemi/darnlink@v0.20.0" darnlink . --robustify --create-frontmatter --write
#
...
DARNLINK_REF="${DARNLINK_REF:-d5b5ee3ebfb0ccecd9c894c47980882ef242aab0}"  # v0.20.0
