...
- `immich_user_config.py`: User-editable configuration.
- `immich_user_config_template.py`: Configuration template without private data.
...
1. Copy the file `immich_user_config_template.py` as `immich_user_config.py`.
