...
class UserResponseWrapper:
    ...
    @classmethod
    def from_context(cls: Type[T], context: Any) -> T:
        """
        Obtiene el usuario actual usando el cliente/contexto y devuelve un UserResponseWrapper.
        El resultado se cachea por id de contexto para optimizar (asume usuario inmutable en la sesión).
        """
...
@lru_cache(maxsize=2)
def _get_user_wrapper_cached(cls: Type[UserResponseWrapper], context: Any, cache_key: int) -> UserResponseWrapper:
