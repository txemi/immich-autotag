...
Wraps permission functions to add automatic event logging,
...
from immich_autotag.permissions.album_permission_executor._remove_members_from_album import (
    remove_members_from_album as _remove_members_from_album,
)
