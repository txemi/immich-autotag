# Immich API Entrypoints Structure (Reference)

This document captures the folder and file structure of the Immich API client package, to guide the refactor and naming alignment for immich_proxy modules.
...
This structure should be used as a reference for renaming and organizing immich_proxy modules, aiming for symmetry and clarity with the API client package.