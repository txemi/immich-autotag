...
@typechecked
def try_autofix(asset_wrapper: 'AssetResponseWrapper', duplicate_wrapper: 'AssetResponseWrapper', fix_type: str, tag_to_add: str, verbose: bool) -> None:
    """
    Realiza el autofix de etiquetas de clasificación entre duplicados.
    """
    from immich_autotag.logging.utils import log
    from immich_autotag.logging.levels import LogLevel
    if fix_type == "autofix_other":
