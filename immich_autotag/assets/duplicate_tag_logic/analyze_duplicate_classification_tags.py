...
class DuplicateTagAnalysisReport:
    ...
    _result: DuplicateTagAnalysisResult = attrs.field(init=False, default=None, repr=True)
    ...
    def has_changes(self) -> bool:
        return self._result in (DuplicateTagAnalysisResult.AUTOFIXED, DuplicateTagAnalysisResult.CONFLICT)
    ...
    @classmethod
    def analyze(cls, asset_wrapper: AssetResponseWrapper) -> "DuplicateTagAnalysisReport":
    ...
    def _perform_analysis(self) -> None:
        ...
        self._finalize_result(duplicate_asset_ids, compared_asset_ids, error_messages, any_autofix, all_equal)

    def _get_duplicate_ids(self, duplicate_wrappers: list[AssetResponseWrapper], asset_id: AssetUUID) -> list[AssetUUID]:
    ...
    def _finalize_conflict(self, compared_asset_ids: list[AssetUUID], error_messages: list[str]) -> None:
