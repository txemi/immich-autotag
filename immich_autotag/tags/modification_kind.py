...
class ModificationKind(Enum):
    ...
    WARNING_TAG_REMOVAL_FROM_ASSET_FAILED = ModificationKindInfo("WARNING_TAG_REMOVAL_FROM_ASSET_FAILED")
    WARNING_ASSET_ALREADY_IN_ALBUM = ModificationKindInfo("WARNING_ASSET_ALREADY_IN_ALBUM")
    ...
    ERROR_ASSET_SKIPPED_RECOVERABLE = ModificationKindInfo("ERROR_ASSET_SKIPPED_RECOVERABLE")
    ...
    ALBUM_PERMISSION_RULE_MATCHED = ModificationKindInfo("ALBUM_PERMISSION_RULE_MATCHED")
    ALBUM_PERMISSION_GROUPS_RESOLVED = ModificationKindInfo("ALBUM_PERMISSION_GROUPS_RESOLVED")
    ...
    ALBUM_PERMISSION_SHARE_FAILED = ModificationKindInfo("ALBUM_PERMISSION_SHARE_FAILED")
