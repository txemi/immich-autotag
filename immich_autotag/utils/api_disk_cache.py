...
class ApiCacheManager:
    ...
    def _get_cache_dir(self, run_dir: Optional[Path] = None) -> Path:
        ...
        cache_dir = run_dir / self._cache_subdir / self._cache_type.value
    ...
    def load(self, key: str) -> Optional[dict[str, object]]:
        ...
        for run_dir in RunOutputManager.find_recent_run_dirs(logs_dir, exclude_current=True):
            prev_cache_dir = run_dir / self._cache_subdir / self._cache_type.value
