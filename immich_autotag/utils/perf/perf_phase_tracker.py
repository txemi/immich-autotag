...
Permite registrar tiempos de inicio y fin de fases clave (lazy load, full load, asset process) y loguear un resumen en cualquier momento (incluyendo excepciones).
"""
